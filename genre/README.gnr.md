...
@abaghan (25/10/2014 - 26/10/2014): 

  * File `cca.R` added to the `library.gnr`.  
  * Running `cca` analysis on my notebook took an hour and my pc started to
    make strange noises. Added alarm notes to the `r.gnr/03.cca.R`.
