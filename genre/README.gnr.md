...
## Directories
  ...
  * `playground`: laberatory of r codes
  * `proceeding`: abstracts, presntations and other files generated for the conferences
  * `publication`: submission and revission files
  * `report`: temperary report files generated by r
