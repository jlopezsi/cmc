...
oci.mn1<-multinom(as.factor(oci_en.Mclust$classification)~Genre+Age+YEducation+PEducation+Occupation+Language+SizeTown+Region, weights=ej12_8$Pes, data=oci.ilu1_en)
...
oci.mn2<-multinom(as.factor(oci_en.Mclust$classification)~YEducation+Genre+SizeTown+Age*PEducation+Language+PEducation+Region, weights=ej12_8$Pes, data=oci.ilu1_en)
...
oci.mn3<-multinom(as.factor(oci_en.Mclust$classification)~YEducation+Genre*PEducation+SizeTown+Age*PEducation+Language+PEducation+Region, weights=ej12_8$Pes, data=oci.ilu1_en)
