...
library(descr)
crosstab(oci.ilu1_en$PEducation, oci.ilu1_en$Age)
crosstab(oci.ilu1_en$YEducation, oci.ilu1_en$Occupation)
oci.ilu1.en.complete<-na.omit(oci.ilu1_en)
class(oci.ilu1.en.complete)
count(is.na(oci.ilu1.en.complete$Occupation))

oci.ilu1_en$Occupation<-oci.ilu1_en$Occupation[is.na(oci.ilu1_en$Occupation)==TRUE]<-'AveQual'


count(is.na(oci.ilu1_en$Occupation))
count(!is.na(oci.ilu1_en$Occupation))

plot(oci.ilu1_en$Occupation)
